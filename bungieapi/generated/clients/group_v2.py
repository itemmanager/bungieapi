...
class Client(BaseClient):
    ...
    async def get_user_clan_invite_setting(
        self,
        m_type: t.Optional["BungieMembershipType"] = None,
    ) -> booleanClientResponse:
    ...
    async def get_recommended_groups(
        self,
        create_date_range: t.Optional["GroupDateRange"] = None,
    ...
    async def get_group_by_name_v2(
        self,
        request: t.Optional["GroupNameSearchRequest"],
    ) -> GroupClientResponse:
        """Get information about a specific group with the given name and type.
    ...
    async def edit_group(
        self,
        request: t.Optional["GroupEditAction"],
        group_id: t.Optional[int] = None,
    ) -> int32ClientResponse:
    ...
    async def edit_founder_options(
        self,
        request: t.Optional["GroupOptionsEditAction"],
        group_id: t.Optional[int] = None,
    ) -> int32ClientResponse:
    ...
    async def add_optional_conversation(
        self,
        request: t.Optional["GroupOptionalConversationAddRequest"],
        group_id: t.Optional[int] = None,
    ) -> int64ClientResponse:
    ...
    async def edit_optional_conversation(
        self,
        request: t.Optional["GroupOptionalConversationEditRequest"],
    ...
    async def ban_member(
        self,
        request: t.Optional["GroupBanRequest"],
        group_id: t.Optional[int] = None,
        membership_id: t.Optional[int] = None,
        membership_type: t.Optional["BungieMembershipType"] = None,
    ) -> int32ClientResponse:
    ...
    async def abdicate_foundership(
        self,
        founder_id_new: t.Optional[int] = None,
        group_id: t.Optional[int] = None,
        membership_type: t.Optional["BungieMembershipType"] = None,
    ) -> booleanClientResponse:
    ...
    async def approve_all_pending(
        self,
        request: t.Optional["GroupApplicationRequest"],
        group_id: t.Optional[int] = None,
    ) -> ListOfEntityActionResultClientResponse:
    ...
    async def approve_pending_for_list(
        self,
        request: t.Optional["GroupApplicationListRequest"],
        group_id: t.Optional[int] = None,
    ) -> ListOfEntityActionResultClientResponse:
        """Approve all of the pending users for the given group.
    ...
    async def get_groups_for_member(
        self,
        filter: t.Optional["GroupsForMemberFilter"] = None,
        group_type: t.Optional["GroupType"] = None,
        membership_id: t.Optional[int] = None,
        membership_type: t.Optional["BungieMembershipType"] = None,
    ) -> GetGroupsForMemberClientResponse:
    ...
    async def get_potential_groups_for_member(
        self,
        filter: t.Optional["GroupPotentialMemberStatus"] = None,
        group_type: t.Optional["GroupType"] = None,
        membership_id: t.Optional[int] = None,
        membership_type: t.Optional["BungieMembershipType"] = None,
    ) -> GroupPotentialMembershipSearchClientResponse:
