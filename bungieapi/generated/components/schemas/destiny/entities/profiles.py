...
class DestinyVendorReceiptsComponent:
    ...
    receipts: t.Optional[
        t.Sequence["DestinyVendorReceipt"]
    ] = None  # The receipts for refundable purchases made at a vendor.
...
class DestinyProfileComponent:
    ...
    character_ids: t.Optional[
        t.Sequence[int]
    ] = None  # A list of the character IDs, for further querying on your part.
    ...
    date_last_played: t.Optional[
        str
    ] = None  # The last time the user played with any character on this Profile.
    season_hashes: t.Optional[
        t.Sequence[int]
    ...
    user_info: t.Optional[
        "UserInfoCard"
    ] = None  # If you need to render the Profile (their platform name, icon, etc...) somewhere, this property contains that information.
    versions_owned: t.Optional[
        "DestinyGameVersions"
...
from bungieapi.generated.components.schemas.destiny.vendors import (
