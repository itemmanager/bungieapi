...
class DestinyManifest:
    ...
    icon_image_pyramid_info: t.Optional[
        t.Sequence["ImagePyramidEntry"]
    ...
    json_world_component_content_paths: t.Optional[
    ...
    json_world_content_paths: t.Optional[
        t.Mapping[str, str]
    ] = None  # This points to the generated JSON that contains all the Definitions. Each key is a locale. The value is a path to the aggregated world definitions (warning: large file!)
    mobile_asset_content_path: t.Optional[str] = None
    mobile_clan_banner_database_path: t.Optional[str] = None
    mobile_gear_asset_data_bases: t.Optional[
        t.Sequence["GearAssetDataBaseDefinition"]
    ] = None
    mobile_gear_cdn: t.Optional[t.Mapping[str, str]] = None
    mobile_world_content_paths: t.Optional[t.Mapping[str, str]] = None
...
class ImagePyramidEntry:
    factor: t.Optional[
        float
    ] = None  # The factor by which the original image size has been reduced.
    name: t.Optional[
        str
    ] = None  # The name of the subfolder where these images are located.
