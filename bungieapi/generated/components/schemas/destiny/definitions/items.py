...
When entities refer to each other in Destiny content, it is this hash that they are referring to."""
    ...
    infusion_process: "DestinyItemTierTypeInfusionBlock" = dt.field(
        metadata={
...
class DestinyItemTierTypeInfusionBlock:
    base_quality_transfer_ratio: float = dt.field(
        metadata={
    ...
    minimum_quality_increment: int = dt.field(
        metadata={
...
class DestinyDerivedItemCategoryDefinition:
    ...
    category_description: str = dt.field(
        metadata={
    ...
    items: t.Sequence["DestinyDerivedItemDefinition"] = dt.field(
        metadata={
...
class DestinyDerivedItemDefinition:
    ...
    icon_path: str = dt.field(metadata={"description": "An icon for the item."})
    item_description: str = dt.field(
        metadata={"description": "A brief description of the item."}
    )
    item_detail: str = dt.field(
        metadata={
            "description": "Additional details about the derived item, in addition to the description."
        }
    )
    item_name: str = dt.field(metadata={"description": "The name of the derived item."})
    ...
    item_hash: t.Optional[int] = dt.field(
        default=None,
        metadata={
...
class DestinyItemPlugDefinition:
    ...
    alternate_plug_style: "PlugUiStyles" = dt.field(
        metadata={
    ...
    alternate_ui_plug_label: str = dt.field(
        metadata={
    ...
    enabled_rules: t.Sequence["DestinyPlugRuleDefinition"] = dt.field(
        metadata={
...
The live data DestinyItemPlugComponent.enableFailIndexes will be an index into this array, so you can pull out the failure strings appropriate for the user."""
    ...
    energy_capacity: "DestinyEnergyCapacityEntry" = dt.field(
        metadata={
    ...
    energy_cost: "DestinyEnergyCostEntry" = dt.field(
        metadata={
    ...
    insertion_rules: t.Sequence["DestinyPlugRuleDefinition"] = dt.field(
        metadata={
...
If this is populated, it will have the override data to be applied when this plug is applied to an item."""
    ...
    plug_availability: "PlugAvailabilityMode" = dt.field(
        metadata={
    ...
    plug_category_hash: int = dt.field(
        metadata={
...
class DestinyPlugRuleDefinition:
    ...
    failure_message: str = dt.field(
        metadata={"description": "The localized string to show if this rule fails."}
    )
...
class DestinyEnergyCapacityEntry:
    ...
    capacity_value: int = dt.field(
        metadata={"description": "How much energy capacity this plug provides."}
    )
...
class DestinyEnergyCostEntry:
    ...
    energy_cost: int = dt.field(
        metadata={"description": "The Energy cost for inserting this plug."}
    )
    energy_type: "DestinyEnergyType" = dt.field(
        metadata={
